...
require_pattern "lesson/SYNC_GATES_14_DAYS.tsv" 'Day 3.*check_repository_boundary\.sh --product-required && tools/check_git_sync\.sh --product' "Day 3 product boundary gate"
