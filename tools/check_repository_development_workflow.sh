...
require_file "skills/lesson-repository-development/SKILL.md"
require_file "skills/lesson-repository-development/references/repository-development.md"
require_file "skills/lesson-repository-development/agents/openai.yaml"
...
require_pattern "AGENTS.MD" 'skills/lesson-repository-development/SKILL\.md' "lesson repository development skill route"

require_pattern "skills/lesson-repository-development/SKILL.md" '^description: .*Use when' "skill trigger phrase"
require_pattern "skills/lesson-repository-development/SKILL.md" 'AGENTS\.MD' "AGENTS reference"
require_pattern "skills/lesson-repository-development/SKILL.md" 'worklog-doc-sync' "worklog route"
require_pattern "skills/lesson-repository-development/SKILL.md" 'lesson-sync-gate' "lesson sync route"
require_pattern "skills/lesson-repository-development/SKILL.md" 'repository-development-workflow' "workflow CLI reference"
require_pattern "skills/lesson-repository-development/references/repository-development.md" 'context_triage' "phase reference"
require_pattern "skills/lesson-repository-development/references/repository-development.md" 'release_gate' "release phase reference"
require_pattern "skills/lesson-repository-development/references/repository-development.md" 'explicit developer approval' "approval reference"
...
require_policy_row "docs/workflow/TEST_PLAN_MANIFEST.tsv" '^skills/lesson-repository-development/\t' "test-plan skill row"
