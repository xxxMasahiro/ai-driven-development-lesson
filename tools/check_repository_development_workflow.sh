...
"$ROOT/tools/check_development_instruction.sh" >/dev/null || missing=1
...
require_file "docs/workflow/DEVELOPMENT_INSTRUCTION_POLICY.tsv"
require_file "docs/workflow/DEVELOPMENT_AUTONOMY_WORKFLOW.tsv"
require_file "docs/workflow/INSTRUCTION_MEMORY.md"
...
require_file "tools/lib/development_instruction.sh"
require_file "tools/lib/development_instruction.mjs"
require_executable "tools/repository-development-workflow"
require_executable "tools/development-instruction"
require_executable "tools/check_development_instruction.sh"
require_executable "tools/test_development_instruction.sh"
...
require_pattern "skills/repository-development-workflow/SKILL.md" 'instruction --stage A' "A-F instruction route"
...
require_pattern "skills/repository-development-workflow/references/repository-development.md" 'task scope' "task-scope reference"
require_pattern "skills/repository-development-workflow/references/repository-development.md" 'explicit (developer )?approval' "dangerous-operation approval reference"
...
require_pattern "tools/repository-development-workflow" 'instruction --stage' "instruction projection subcommand"
...
require_policy_row "docs/workflow/GIT_HOOK_CHECKS.tsv" '^check_development_instruction\t' "instruction hook check row"
require_policy_row "docs/workflow/GIT_HOOK_CHECKS.tsv" '^test_development_instruction\t' "instruction hook test row"
...
require_policy_row "docs/workflow/GIT_HOOK_PARALLEL_GROUPS.tsv" '^check_development_instruction\t' "instruction parallel check row"
require_policy_row "docs/workflow/GIT_HOOK_PARALLEL_GROUPS.tsv" '^test_development_instruction\t' "instruction parallel test row"
...
require_policy_row "docs/workflow/TEST_PLAN_MANIFEST.tsv" '^docs/workflow/DEVELOPMENT_INSTRUCTION_POLICY.tsv\t' "test-plan instruction policy row"
require_policy_row "docs/workflow/TEST_PLAN_MANIFEST.tsv" '^tools/lib/development_instruction.mjs\t' "test-plan instruction resolver row"
...
require_policy_row "docs/workflow/FINAL_GATE_COVERAGE.tsv" '^[.]/tools/check_development_instruction.sh\t' "final-gate instruction check coverage"
require_policy_row "docs/workflow/FINAL_GATE_COVERAGE.tsv" '^[.]/tools/test_development_instruction.sh\t' "final-gate instruction test coverage"
require_policy_row "docs/workflow/FINAL_GATE_COVERAGE.tsv" '^[.]/tools/development-instruction status --target parent\tgap\tdevelopment_instruction_status\t' "final-gate instruction status coverage"
...
require_pattern "tools/test_lesson_repository.sh" '\./tools/check_development_instruction\.sh' "aggregate instruction check wiring"
require_pattern "tools/test_lesson_repository.sh" '\./tools/test_development_instruction\.sh' "aggregate instruction test wiring"
