...
| 20 | Design Studio | Event Runner を実装する | 基盤のみ |
| 21 | Design Studio | Request / Proposal Store を永続化する | 基盤のみ |
| 22 | Design Studio | サブスク型 / APIキー型 / 手動型 AI Agent Connection Layer を実装する | 基盤のみ |
