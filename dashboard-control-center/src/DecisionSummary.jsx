...
export function DetailDecisionSummary({ tone, items, t }) {
  return (
  ...
  return (
    <DetailDecisionSummary
      ...
      items={[
        ...
        { Icon: ArrowRightCircle, label: t("detail.nextSafeCheck"), value: displayText(decision.next_safe_action), detail: technicalDrilldown },
      ]}
    />
  );
}
